...
import { GatewayEventType } from "gateway-contracts";
...
export class EventDistributionService {
    ...
    // async distribute(launchId: string, dedupKey: string, event: GatewayEventBase) {
    ...
    // private async safeExecute(operation: string, event: GatewayEventBase<GatewayEventType>, action: () => Promise<void>) {
